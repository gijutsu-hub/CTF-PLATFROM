...
include('session.php');
include('../conn.php');
$sql = mysqli_query($con,"SELECT * FROM achivment where userid = '$username'");
...
<div class="app-container">
  ...
  <div class="app-main">
    ...
    <div class="chart-container-wrapper small">
        <div class="chart-container">
          ...
          <div class="chart-container-header">
            <h3>Achivement Description</h3>
          </div>
          <p class="profile-text">Achive Date</p>
          </div>
        </div>
  <?php
  ...
  <div class="chart-container-wrapper small">
        <div class="chart-container">
          <div class="chart-container-header">
            <h3><?php echo $row["achivement"]?></h3>
          </div>
          <div class="chart-container-header">
            <h3><?php echo $row["achivementdesc"]?></h3>
          </div>
          <p class="profile-text"><?php echo $row["date"]?></p>
          </div>
        </div>
        <?php
         }
