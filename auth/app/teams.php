...
include('session.php');
include('../conn.php');
$sqlz = mysqli_query($con,"SELECT * FROM team where userid = '$username'");
 $rowz = mysqli_fetch_array($sqlz, MYSQLI_ASSOC);
 $tid = $rowz['tid'];
$sql = mysqli_query($con,"SELECT * FROM team where tid = '$tid'");
...
<div class="app-container">
  ...
  <div class="app-main">
    <h2 style="color:#FFFFFF">Team Members</h2>
  ...
  <div class="chart-container-wrapper small">
        <div class="chart-container">
          ...
          <p class="profile-text"><?php echo $row["userid"]?></p>
          </div>
        </div>
        <?php
         }
