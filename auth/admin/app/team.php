...
if(isset($_GET['id'])){
$id = $_GET['id'];
$sql = mysqli_query($con,"SELECT * FROM team where tname = '$id'");
}else{
$sql = mysqli_query($con,"SELECT DISTINCT tname,tid FROM team");
}
?>
<!DOCTYPE html>
<html lang="en" >
