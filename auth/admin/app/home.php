...
if(isset($_GET['id'])){
$id = $_GET['id'];
$sql = mysqli_query($con,"SELECT * FROM usdetails where userid = '$id'");
}else{
$sql = mysqli_query($con,"SELECT * FROM usdetails ");
}
?>
<!DOCTYPE html>
<html lang="en" >
...
<div class="app-container">
  ...
  <div class="app-main">
    <h2 style="color:#FFFFFF">TOTAL USER</h2>
    <div class="chart-container-wrapper small">
        <div class="chart-container">
        <form action="" method="GET">
        <div class="input-group input-group-lg mb-3">
  <input type="text" name="id" class="form-control" placeholder="username" aria-label="Search user" aria-describedby="basic-addon2">
