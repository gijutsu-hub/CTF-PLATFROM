...
include ('../../mail.php');
include ('session.php');
$sql = mysqli_query($con,"SELECT * FROM contact where messageid='$id'");
$row = mysqli_fetch_array($sql, MYSQLI_ASSOC);
$username = $row['username'];
$email = $row['email'];
if(isset($_POST['msg'])){
    $msg = $_POST['msg'];
    $result = mysqli_query($con,"UPDATE contact SET reply='$msg' WHERE messageid='$id'");
    if($result){
...
<body data-new-gr-c-s-loaded="14.1078.0" style="width:100%;font-family:arial, "helvetica neue", helvetica, sans-serif;-webkit-text-size-adjust:100%;-ms-text-size-adjust:100%;padding:0;Margin:0"><div class="es-wrapper-color" style="background-color:#FAFAFA"><!--[if gte mso 9]><v:background xmlns:v="urn:schemas-microsoft-com:vml" fill="t"> <v:fill type="tile" color="#fafafa"></v:fill> </v:background><![endif]--><table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;padding:0;Margin:0;width:100%;height:100%;background-repeat:repeat;background-position:center top;background-color:#FAFAFA"><tr><td valign="top" style="padding:0;Margin:0"><table cellpadding="0" cellspacing="0" class="es-content" align="center" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;table-layout:fixed !important;width:100%"><tr><td align="center" style="padding:0;Margin:0"><table bgcolor="#ffffff" class="es-content-body" align="center" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px;background-color:#FFFFFF;width:600px"><tr><td align="left" style="Margin:0;padding-bottom:20px;padding-left:20px;padding-right:20px;padding-top:30px"><table cellpadding="0" cellspacing="0" width="100%" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"><tr><td align="center" valign="top" style="padding:0;Margin:0;width:560px"><table cellpadding="0" cellspacing="0" width="100%" role="presentation" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-collapse:collapse;border-spacing:0px"><tr><td align="left" class="es-m-txt-l" style="padding:0;Margin:0;padding-bottom:10px"><h1 style="Margin:0;line-height:46px;mso-line-height-rule:exactly;font-family:arial, "helvetica neue", helvetica, sans-serif;font-size:46px;font-style:normal;font-weight:bold;color:#333333">Reply to'.$msg.'</h1>
        ...
        $mail->send();
        mysqli_query($con,"UPDATE contact SET solved='TRUE' WHERE messageid='$id'");
        $msg = "Reply Send to user";
    }
    else{
        $msg = "error happened";
    }
...
<div class="app-left">
  ...
  <div class="main-header-line">
    ...
    <div class="chart-container-wrapper small">
      ...
      <input class="form-control" id="disabledInput" type="text" name="uid" value="<?php echo $row['username']; ?>" disabled>
      </div>
      <div class="form-col">&nbsp;&nbsp;&nbsp;&nbsp;</div>
      <div class="form-col">
      <label for="" style="color:#FFFFFF">Email</label><br>
      <input class="form-control" id="disabledInput" type="text" name="email" value="<?php echo $row['email'] ?>" disabled>
      </div>
      </div>
    ...
    <input class="form-control" id="exampleFormControlSelect1" name="cname" value="<?php echo $row['ctfname'] ?>" disabled>
  </div>
      <div class="form-row">
      <label for="" style="color:#FFFFFF">Subject</label><br>
      <input type="text" name="sub" class="form-control" value="<?php echo $row['subject'] ?>" disabled>
      <small id="passwordHelpBlock" class="form-text text-muted">This is the subject of the problem</small> </div>
      <div class="form-row"><br></div>
      <div class="form-row">
      <label for="" style="color:#FFFFFF">Sender Message</label><br>
      <input type="text" name="sub" class="form-control" value="<?php echo $row['descrip'] ?>" disabled>
      <small name="resource" class="form-text text-muted">The Problem statement is written and displayed here kindly read prperly and the give the solution</small></div>
    </div>
    <div class="form-row"><br></div>
    <div class="form-row">
      <label for="" style="color:#FFFFFF">Reply Message</label><br>
      <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" name="msg" required></textarea>
      <small name="resource" class="form-text text-muted">Write a proper solution of the problem mentiond above</small></div>
    <div class="form-row"><br></div>
