...
include('../../conn.php');
include ('session.php');
$sql = mysqli_query($con,"SELECT * FROM contact where solved = 'FALSE' ORDER BY time");
?>
<!DOCTYPE html>
<html lang="en" >
<head>
...
<div class="app-container">
  ...
  <div class="app-main">
      <h2 style="color:#FFFFFF">Support Messages</h2>
