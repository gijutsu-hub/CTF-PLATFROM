...
if(isset($_GET['ix'])){
$ix = $_GET['ix'];
$sql = mysqli_query($con,"SELECT * FROM grand where id = '$ix'");
}
else{
$sql = mysqli_query($con,"SELECT * FROM grand");
}
?>
<!DOCTYPE html>
<html lang="en" >
