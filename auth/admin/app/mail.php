...
$sql4 = mysqli_query($con,"SELECT * FROM users");
if(isset($_POST['user'])){
  $user = $_POST['user'];
  $sub = $_POST['sub'];
  $body = $_POST['body'];
...
if(strcmp($user,"All user")==0){
  ...
  $sql5 = mysqli_query($con,"SELECT * FROM users where userid='$user'");
...
<div class="app-left">
  ...
  <div class="main-header-line">
    ...
    <div class="chart-container-wrapper small">
      ...
      <div class="form-group">
    <label for="exampleFormControlSelect1" style="color:#FFFFFF">Select user</label>
...
if ($sql3->num_rows > 0) {
  while($row3 = $sql3->fetch_assoc()) {
     ?>
      <option><?php echo ($row3['userid']); ?></option>
      <?php
         }
        }?>
    </select>
      ...
      <div class="form-row">
      <label for="" style="color:#FFFFFF">Mail Subject</label><br>
      <input type="text" name="sub" class="form-control" placeholder="Subject of the email" required>
      <small id="passwordHelpBlock" class="form-text text-muted">Mail subject should be very classy </small> </div>
    <div class="form-row"><br></div>
    <div class="form-row">
      <label for="" style="color:#FFFFFF">Email body</label><br>
      <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" name="body" required></textarea>
      <small name="resource" class="form-text text-muted">both you can use html and text to send email</small></div>
    <div class="form-row"><br></div>
