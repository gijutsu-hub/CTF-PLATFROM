...
if(isset($_GET['id'])){
$ix = $_GET['id'];
$sql = mysqli_query($con,"SELECT * FROM usrctf where id = '$id' AND id = '$badge'");
}
else{
$sql = mysqli_query($con,"SELECT * FROM usrctf where position = '$badge' ");
}
}
?>
<!DOCTYPE html>
...
<div class="app-container">
  ...
  <div class="app-main">
    <h2 style="color:#FFFFFF">TOTAL AWARDS</h2>
    <div class="chart-container-wrapper small">
        <div class="chart-container">
        <form action="" method="GET">
        <div class="input-group input-group-lg mb-3">
  <input type="text" name="ix" class="form-control" placeholder="Team Name" aria-label="Search challenge" aria-describedby="basic-addon2">
  <div class="input-group-append">
  <button type="submit" class="btn btn-primary">Search Team</button>
  <div class="input-group-append">
  &nbsp;&nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
  <div class="input-group-append">
  <button type="button" class="btn btn-primary" onclick="location.href='addawards.php';">Add Awards</button>
</div>
</div>
  </div>
</div>
